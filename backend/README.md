...
## Project Structure
    ...
    ├── twilight_snowflake_2  # Django project configurations
...
1. Clone this repo and `cd twilight_snowflake_2`
...
2. Clone this repo and `cd twilight_snowflake_2`
