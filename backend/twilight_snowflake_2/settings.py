"""
Django settings for twilight_snowflake_2 project.
...
ROOT_URLCONF = 'twilight_snowflake_2.urls'
...
WSGI_APPLICATION = 'twilight_snowflake_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_snowflake_2 API",
    "DESCRIPTION": "API documentation for twilight_snowflake_2 App",
    "VERSION": "v1",
}
